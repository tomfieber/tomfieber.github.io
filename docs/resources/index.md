...
- [ ] Test for [SQLi](cheatsheets/sqli.md){ data-preview }
- [ ] Test for NoSQLi
...
- [ ] Check for [open redirects](cheatsheets/open-redirects.md){ data-preview }
...
- [ ] Is the input reflected anywhere on the page?
	- [ ] What is the context?
- [ ] Check for [XSS](cheatsheets/xss.md){ data-preview }
- [ ] Check for [SQLi](cheatsheets/sqli.md){ data-preview }
- [ ] Check for SSTI
- [ ] What is the content-type of the request?
	- [ ] Check for [XXE](cheatsheets/xxe.md){ data-preview }
	- [ ] Try converting JSON to XML

## State-Changing Actions

- [ ] Check for [CSRF](cheatsheets/csrf.md){ data-preview }
- [ ] Check for [broken access control](cheatsheets/broken-access-control.md){ data-preview }

## Sensitive data returned

- [ ] Check [CORS](cheatsheets/cors.md){ data-preview }
- [ ] Try to send a `POST` or `PUT` request with the data in the body to see if it's possible to update

## Query strings

- [ ] Check for [local file read](cheatsheets/local-file-read.md){ data-preview } or file inclusion
- [ ] Check for SQLi
