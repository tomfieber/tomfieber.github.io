...
- [ ] Check that the OAuth service properly validates the `redirect_uri` parameter
	- [ ] CSRF-like attack that tricks the victim into initiating a flow that will leak the code or token to an attacker controlled URI