...
!!! warning "Important note"
	...
	Make sure the request is coming from the server and not your browser before reporting.
...
- [ ] Chaining HTML injection/XSS
	- Try something like `<script>document.write(document.location)</script>`
