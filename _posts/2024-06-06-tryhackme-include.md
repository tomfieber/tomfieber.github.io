...
![](assets/images/Pasted%20image%2020240606074209.png)
...
![](assets/images/Pasted%20image%2020240606202332.png)

After logging in with `guest:guest` we're greeted with a "Review App". 

![](assets/images/Pasted%20image%2020240606202537.png)
...
![](assets/images/Pasted%20image%2020240606202756.png)
...
![](assets/images/Pasted%20image%2020240606203123.png)
...
![](assets/images/Pasted%20image%2020240607080247.png)
...
![](assets/images/Pasted%20image%2020240607080714.png)
...
![](assets/images/Pasted%20image%2020240607081809.png)

Perfect. Let's see if we can inject a PHP web shell here. 

![](assets/images/Pasted%20image%2020240607081938.png)
...
![](assets/images/Pasted%20image%2020240607082114.png)

After checking the log again along with the `id` command, we can see that we've got command execution. 

![](assets/images/Pasted%20image%2020240607082700.png)
...
![](assets/images/Pasted%20image%2020240607083339.png)
