  ...
  Y = (e, s, d, n) => {
    if ((s && typeof s == 'object') || typeof s == 'function')
      for (let m of K(s))
        !Q.call(e, m) &&
          m !== d &&
          C(e, m, { get: () => s[m], enumerable: !(n = J(s, m)) || n.enumerable });
    return e;
  };
var Z = (e) => Y(C({}, '__esModule', { value: !0 }), e);
var c = (e, s, d) =>
  new Promise((n, m) => {
    var l = (t) => {
        try {
      ...
      r = (t) => (t.done ? n(t.value) : Promise.resolve(t.value).then(l, o));
...
var h = require('obsidian'),
  ...
  g = class extends h.PluginSettingTab {
    constructor(s, d) {
    ...
    display() {
      ...
      (n.createDiv({ cls: 'setting-item-name', text: 'Color scheme' }),
        n.createDiv({ cls: 'setting-item-description' }).appendChild(d),
        ...
        new h.SettingGroup(s)
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.colorfulActiveStates).onChange((i) => {
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.colorfulHeadings).onChange((i) => {
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.underlineInternal).onChange((i) => {
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.underlineExternal).onChange((i) => {
          ...
          .addSetting((t) =>
            t
              ...
              .addToggle((a) =>
                a.setValue(this.plugin.settings.fullWidthMedia).onChange((i) => {
      ...
      (l.appendText('These options can also be defined per file. See '),
        l.appendChild(
          createEl('a', {
            text: 'documentation',
        ...
        l.appendText(' for details.'));
      let o = document.createDocumentFragment();
      (o.createDiv({ cls: 'setting-item-name', text: 'Layout' }),
        o.createDiv({ cls: 'setting-item-description' }).appendChild(l),
        new h.SettingGroup(s)
          .setHeading(o)
          .addSetting((t) =>
            t
...
function O(e) {
  (e.addCommand({
    ...
    callback: () => {
      ((e.settings.bordersToggle = !e.settings.bordersToggle), e.saveData(e.settings), e.refresh());
    },
  }),
    e.addCommand({
    ...
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.focusMode = !e.settings.focusMode), e.saveData(e.settings), e.refresh());
      },
    }),
    e.addCommand({
    ...
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.imgGrid = !e.settings.imgGrid), e.saveData(e.settings), e.refresh());
      },
    }),
    e.addCommand({
    ...
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.devBlockWidth = !e.settings.devBlockWidth),
          e.saveData(e.settings),
          e.refresh());
      },
    }));
}
var f = ['minimal-light', 'minimal-light-tonal', 'minimal-light-contrast', 'minimal-light-white'],
...
var u = ['table-100', 'table-default-width', 'table-wide', 'table-max'],
  ...
  p = ['map-100', 'map-default-width', 'map-wide', 'map-max'],
  D = ['chart-100', 'chart-default-width', 'chart-wide', 'chart-max'];
function M(e) {
  (e.addCommand({
    id: 'toggle-minimal-dark-cycle',
    name: 'Cycle between dark mode styles',
    callback: () => {
      ((e.settings.darkStyle = k[(k.indexOf(e.settings.darkStyle) + 1) % k.length]),
        e.saveData(e.settings),
        e.updateDarkStyle());
    },
  }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.lightStyle = f[(f.indexOf(e.settings.lightStyle) + 1) % f.length]),
          e.saveData(e.settings),
          e.updateLightStyle());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.tableWidth = u[(u.indexOf(e.settings.tableWidth) + 1) % u.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.imgWidth = b[(b.indexOf(e.settings.imgWidth) + 1) % b.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.iframeWidth = S[(S.indexOf(e.settings.iframeWidth) + 1) % S.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.chartWidth = D[(D.indexOf(e.settings.chartWidth) + 1) % D.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }),
    e.addCommand({
      ...
      callback: () => {
        ((e.settings.mapWidth = p[(p.indexOf(e.settings.mapWidth) + 1) % p.length]),
          e.saveData(e.settings),
          e.refresh());
      },
    }));
...
function F(e) {
  (e.addCommand({
    ...
    callback: () => {
      ((e.settings.lightStyle = 'minimal-light'), e.saveData(e.settings), e.updateLightStyle());
    },
  }),
    e.addCommand({
...
function E(e) {
  (e.addCommand({
    ...
    callback: () => {
      ((e.settings.darkStyle = 'minimal-dark'), e.saveData(e.settings), e.updateDarkStyle());
    },
  }),
    e.addCommand({
...
function I() {
  var s;
  let e = document.getElementById('minimal-theme');
  (e && ((s = e.parentNode) == null || s.removeChild(e)),
    document.body.classList.remove('minimal-theme'));
}
function U(e) {
  (L(),
    x(),
    document.body.addClass(e.lightStyle, e.lightScheme, e.darkStyle, e.darkScheme),
    ...
    document.body.classList.toggle('minimal-dev-block-width', e.devBlockWidth),
    ...
    document.body.addClass(e.chartWidth, e.tableWidth, e.imgWidth, e.iframeWidth, e.mapWidth));
  let s = document.getElementById('minimal-theme');
  if (s)
    s.innerText =
...
function R(e) {
  (y(), document.body.addClass(e.darkScheme));
}
function _(e) {
  (v(), document.body.addClass(e.lightScheme));
}
function j(e) {
  if (e.vault.getConfig('theme') === 'system')
    ...
    document.body.classList.contains('theme-light')
      ? (document.body.removeClass('theme-light'), document.body.addClass('theme-dark'))
      : (document.body.removeClass('theme-dark'), document.body.addClass('theme-light'));
    let d = e.vault.getConfig('theme') === 'moonstone' ? 'obsidian' : 'moonstone';
...
var w = class extends q.Plugin {
  ...
  onunload() {
    ...
    (d && d.removeClass('theme-dark'), I(), L(), x(), v(), y());
  }
  loadSettings() {
    return c(this, null, function* () {
  ...
  setupListeners() {
    let s = () => {
        let n = this.app.vault.getConfig('baseFontSize');
        this.settings.textNormal = n;
        let m = !1,
          l = !1,
          o = !1;
        (this.app.vault.getConfig('foldHeading')
          ? ((this.settings.folding = !0), console.log('Folding is on'), (m = !0))
          : ((this.settings.folding = !1), console.log('Folding is off')),
          this.app.vault.getConfig('showLineNumber')
            ? ((this.settings.lineNumbers = !0), console.log('Line numbers are on'), (l = !0))
        ...
        (r.toggle('minimal-folding', m),
          r.toggle('minimal-line-nums', l),
          r.toggle('minimal-readable', o),
          r.toggle('minimal-readable-off', !o),
  ...
  setFontSize() {
    P(this.app, this.settings.textNormal);
  }
  updateDarkStyle() {
    G(this.app, this.settings);
  }
  updateLightStyle() {
    B(this.app, this.settings);
  }
  updateDarkScheme() {
    R(this.settings);
  }
